...
- 配制说明
  ...
  ![](../img/chapter2/CriticalSectionController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/ForEachController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/IncludeController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/InterleaveController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/LoopController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/ModuleController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/OnceOnlyController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/RandomController.png)
...
- 配制说明
  ...
  - `ignore sub-controller blocks`: 忽略子控制器 
  ![](../img/chapter2/RandomOrderController.png)
...
- 配制说明
  ...
  - `HTTP(S) Test Script Recorder`
    ...
    - 设置浏览器的代理地址及端口，点击`HTTP(S) Test Script Recorder`下方的`Start`后，在浏览器中输入地址，即可开始录入<br>
      ![](../img/chapter2/RecordingController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/RuntimeController.png)
...
- 配制说明
  ...
  - 此控制器不需要配制 
  ![](../img/chapter2/SimpleController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/SwitchController.png)
...
- 配制说明
  ...
  - `Per User`: 依据网上的说明在选择`Total Executions`时，勾选时会在每个线程中执行的次数。
  ![](../img/chapter2/ThoughputController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/TransactionController.png)
...
- 配制说明
  ...
  ![](../img/chapter2/WhileController.png)
